...
const LoanBot = (props: SVGProps<SVGSVGElement> | any) => (
  <svg
    width={24}
    height={24}
    fill="none"
  ...
  >
    ...
    />
    <path
      d="M22.302 10.92v5.15c0 3.08-1.76 4.41-4.41 4.41h-8.78c-.75 0-1.42-.11-2-.33-.47-.17-.88-.42-1.21-.74-.18-.17-.04-.44.21-.44h8.78c3.7 0 5.9-2.2 5.9-5.89V7.92c0-.24.27-.39.44-.21.68.72 1.07 1.77 1.07 3.21Z"
    //   fill="#C2D0D6"
    fill={props.index ? "#FFFFFF" : "#C2D0D6"}
    />
  </svg>
