...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <section className="flex basis-3/4">
        <section className="p-5">
          <div className="md:flex md:flex-row">
            <div className="bg-blue md:h-56 rounded-2xl p-5 pt-8 md:shrink-0 basis-3/5">
              ...
              <div className="">
                <div className="md:mt-16 mt-8 ">
                  <Button
                    type="button"
                    variant="outline"
                    className="md:h-14 md:w-44 w-40"
          ...
          <section className="grid md:grid-cols-3 md:gap-3 grid-cols-2 mt-8">
            <div
              className="bg-white md:h-56 h-auto rounded-2xl shadow-2xl md:p-5 p-2 md:mt-0 mt-3 small-card cursor-pointer hover:bg-white-azure"
        ...
        <section className="basis-1/4">ad</section>
      </section>
      ...
      <Drawer position="right" header={'Mobile'} open={isAirtime} close={setIsAirtime}>
        <Tab
          className=""
          data={[
            {
