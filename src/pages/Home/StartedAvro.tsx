...
const StartedAvro = () => {
    return (
        <section className='overflow-x-hidden px-5 py-10'>
            <div className="my-28 bg-[#141C1F] rounded-[40px] grid md:grid-cols-2 place-items-center gap-10 py-10 max-w-[1300px] mx-auto pr-3">
                <div className="ml-3 md:ml-16 text-left md:order-last">
                    ...
                    <Button type="submit" className='w-full sm:w-auto p-3 mt-10 bg-white' style={{ background: 'white', color: '#065373' }} >Download the App</Button>
                </div>
