    ...
    <>
      <div className="flex mt-10">
        <div className="inline-block">
          <Card type="card">
            <h4 className="card_header">Loan Details</h4>
            <div className="block">
        ...
        <div className="inline-block ml-40">
          <Card type="card">
            <h4 className="card_header">Amount Limit</h4>
            <div className="block">
              <div className="inline-block mr-20 mt-5">
      ...
      <div className="flex mt-10">
        <div className="inline-block">
          <Card type="card">
            <h4 className="card_header">Calculated Data</h4>
            <div className="block">
              <div className="inline-block mr-20 mt-5">
                <p className="font-bold">Account Name</p>
                <p>Oluwayemisi Lawal</p>
      ...
      <div className="mt-10 mr-5">
        <Card type="full">
          <div className="p-4">
            <h4 className="card_header mb-10">Remita Salary Response</h4>
            <div className="block">
              <div className="inline-block">
                <p className="font-bold">First Name</p>
                <p>Oluwayemisi</p>
