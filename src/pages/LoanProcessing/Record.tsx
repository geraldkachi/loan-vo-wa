  ...
  return (
    <div>
      <div className="flex flex-row">
        <div>
          <h3 className="component_header">Oluwayemisi Lawal</h3>
          <div className="flex flex-row mt-5">
            <p className="text-grey-slate font-bold text-base">
              Customer's Decision
            </p>
            <Badge color="green" value="Accepted" />
          </div>
        </div>
        {/*<div className="flex justify-end">*/}
        <div className="mt-5 flex justify-end ml-96">
          <div className="flex">
            <div className="inline-block">
              <Button variant="outline">
                <p className="text-red">Decline Request</p>
              </Button>
            </div>
      ...
      <div className="rounded-3xl bg-blue border-slate-100 mt-10 ">
        <div className="flex flex-row justify-between ml-6 p-7">
          ...
          <div>
            ...
            <p className="text-white text-base font-bold">+2348045333212</p>
          </div>
      ...
      <div className="mt-10">
        <Tab
          data={[
            { name: "Personal & Employment Info", render: <PersonalInfo /> },
            { name: "Account Info", render: <AccountInfo /> },
            { name: "Analysis Results", render: <AnalysisResult /> },
